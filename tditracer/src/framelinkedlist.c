...
frame_struct_t* framelinkedlist_create_list(int id, int name, int page, void* buf)
{
...
frame_struct_t* framelinkedlist_add_to_list(int id, int name, int page, void* buf, bool add_to_end)
{
