...
#define KTDIM_IOCTL_GET_TRACEBUFFERSIZE _IO(KTDIM_IOCTL_TYPE, 0)
#define KTDIM_IOCTL_REWIND _IO(KTDIM_IOCTL_TYPE, 1)
#define KTDIM_IOCTL_ON _IO(KTDIM_IOCTL_TYPE, 2)
#define KTDIM_IOCTL_OFF _IO(KTDIM_IOCTL_TYPE, 3)
