mips-TiVo-linux-gnu-g++ -shared -pthread -O2 -Wall libtdi.cpp -o libtdi.so -ldl && cp -v libtdi.so /home/rev/nfs
mips-TiVo-linux-gnu-g++ -pthread -O2 -Wall tdi.cpp -ldl -lrt -o tdi && cp -v tdi /home/rev/nfs 
...
mips-TiVo-linux-gnu-g++ sleeper.cpp -Wall -Wno-unused-variable -o sleeper && cp -v sleeper /home/rev/nfs
